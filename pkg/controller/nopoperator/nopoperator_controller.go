...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileNopOperator{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner NopOperator
...
func newPodForCR(cr *operatorsv1alpha1.NopOperator) *corev1.Pod {
